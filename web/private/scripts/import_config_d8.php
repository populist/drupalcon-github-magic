...
_slack_tell('Importation of Drupal 8 Configuration is starting...', 'drupalcon', 'Drush-on-Pantheon', 'http://live-drupalcon-github-magic.pantheonsite.io/sites/default/files/icons/drush.png', '#A9A9A9');
$output = array();
